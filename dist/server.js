...
/***/ "./main_server/errors/errors.mysql.ts":
/*!********************************************!*\
  !*** ./main_server/errors/errors.mysql.ts ***!
  \********************************************/
/*! exports provided: InvalidFieldInsert */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"InvalidFieldInsert\", function() { return InvalidFieldInsert; });\nclass InvalidFieldInsert extends Error {\r\n    constructor(value, key) {\r\n        super();\r\n        this.message = \"You have tried to insert invalid data in database\";\r\n        this.name = InvalidFieldInsert.name;\r\n        if (value && key) {\r\n            this.message = `The value ${value} must be ${key}`;\r\n        }\r\n    }\r\n}\r\n\n\n//# sourceURL=webpack:///./main_server/errors/errors.mysql.ts?");
...
/***/ "./main_server/server_mod/events_constants/events.contants.ts":
/*!********************************************************************!*\
  !*** ./main_server/server_mod/events_constants/events.contants.ts ***!
  \********************************************************************/
/*! exports provided: VALIDATE_COL, CONSTRUCT_QUERY_MYSQL */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"VALIDATE_COL\", function() { return VALIDATE_COL; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"CONSTRUCT_QUERY_MYSQL\", function() { return CONSTRUCT_QUERY_MYSQL; });\nconst VALIDATE_COL = Symbol(\"VALIDATE_COL\");\r\nconst CONSTRUCT_QUERY_MYSQL = Symbol(\"insertRowsValidate\");\r\n\n\n//# sourceURL=webpack:///./main_server/server_mod/events_constants/events.contants.ts?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"validation\", function() { return validation; });\n/* harmony import */ var _errors_errors_mysql__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../errors/errors.mysql */ \"./main_server/errors/errors.mysql.ts\");\n/* harmony import */ var validator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! validator */ \"validator\");\n/* harmony import */ var validator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(validator__WEBPACK_IMPORTED_MODULE_1__);\n\r\n\r\nvar Validation;\r\n(function (Validation) {\r\n    const rules = Object.seal({\r\n        letters: `/^[A-Za-z]+$/`,\r\n        email: (value) => {\r\n            return validator__WEBPACK_IMPORTED_MODULE_1___default.a.isEmail(value);\r\n        }\r\n    });\r\n    class Validate {\r\n        constructor() {\r\n            this.map = new Map();\r\n            for (let prop in rules) {\r\n                this.map.set(prop, new RegExp(rules[prop]));\r\n            }\r\n        }\r\n        isAcceptable(s, value) {\r\n            if (this.map.has(s)) {\r\n                if (typeof this.map.get(s) == \"function\") {\r\n                    return this.map.get(s).call(null, value);\r\n                }\r\n                else {\r\n                    if (this.map.get(s).test(value))\r\n                        throw new _errors_errors_mysql__WEBPACK_IMPORTED_MODULE_0__[\"InvalidFieldInsert\"](value, s);\r\n                    else\r\n                        return true;\r\n                }\r\n            }\r\n            else\r\n                throw new _errors_errors_mysql__WEBPACK_IMPORTED_MODULE_0__[\"InvalidFieldInsert\"]();\r\n        }\r\n    }\r\n    Validation.Validate = Validate;\r\n})(Validation || (Validation = {}));\r\nconst validation = new Validation.Validate();\r\n\r\n\n\n//# sourceURL=webpack:///./main_server/server_mod/tasks/validation/models.validation.ts?");
